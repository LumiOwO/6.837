...
void SplineParser::SaveBezier(ArgParser *args) {
  ...
  cout << "Saving Bezier to " << args->output_bezier_file << "..." << endl;
...
void SplineParser::SaveBSpline(ArgParser *args) {
  ...
  cout << "Saving BSpline to " << args->output_bspline_file << "..." << endl;
...
void SplineParser::SaveTriangles(ArgParser *args) {
  ...
  cout << "Saving TriangleMesh to " << args->output_file << "..." << endl;
